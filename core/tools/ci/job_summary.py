...
JOBS = {
    ...
    "docs-ci": JobSummary(
        ...
        proves=(
            ...
            "The GitHub Pages site stages into _site/ with SDK API docs, link checks, and browsable test evidence.",
        ),
        details=(
            "The docs-site artifact is the exact _site/ directory promoted by the Pages workflow after CI succeeds.",
            "Report evidence includes generated JSON, logs, XML, and undeclared test artifacts.",
        ),
        site_root="../_site",
    ),
    ...
    "pages-build": JobSummary(
        ...
        proves=(
            "The Pages deployment artifact is the exact site generated by the successful triggering CI run.",
            "Reviewed demo assets, SDK API docs, link-checked static pages, and test evidence are present in _site/.",
        ),
        details=(
            "Pages runs only after the CI workflow succeeds on main, or when manually dispatched.",
            "The published test report includes generated JSON, logs, XML, and undeclared test artifacts.",
        ),
        site_root="../_site",
    ),
