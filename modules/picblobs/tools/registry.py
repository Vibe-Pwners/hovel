...
class Architecture:
    ...
    # Custom constraints use "//modules/picblobs/platforms:{name}" format.
    cpu_constraint: str = ""
...
_register_arch(
    Architecture(
        ...
        cpu_constraint="//modules/picblobs/platforms:mipsel32",
        uses_mmap2=True,
...
_register_arch(
    Architecture(
        ...
        cpu_constraint="//modules/picblobs/platforms:mipsbe32",
        uses_mmap2=True,
        needs_got_reloc=True,
        needs_trampoline=True,
        is_32bit=True,
...
_register_arch(
    Architecture(
        ...
        cpu_constraint="//modules/picblobs/platforms:sparcv8",
        uses_mmap2=True,
        is_32bit=True,
        is_big_endian=True,
    ...
    BlobType(
        ...
        config_schema=ConfigSchema(
            ...
            fields=[
                ...
                ConfigField(name="server_ipv4", type="u8[4]", offset=2),
                # 32-byte handshake auth key, provisioned per deployment.
                # Seals the ephemeral X25519 public-key exchange.
                ConfigField(name="auth_key", type="u8[32]", offset=6),
            ],
            trailing_data=[],
        ),
    )
